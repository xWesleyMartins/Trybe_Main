...
let pecasDeXadrez = "peao"
switch (pecasDeXadrez) {
    case "rei":
        console.log("O Rei se movimenta, se deslocando uma casa na direção horizontal, vertical ou diagonal. Ele tem um movimento especial chamado roque.");
        break;
    case "rainha":
    ...
    case "peao":
        ...
        break
    default:
        console.log("Peça nâo encontrada")
